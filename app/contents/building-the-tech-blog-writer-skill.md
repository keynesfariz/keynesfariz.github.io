...
I've been trying to write more lately. The goal is simple: I want my thoughts to be structured, grammatically correct, and actually published. In the beginning, I only used AI (like Claude chat) to help me with the outline and the grammar of the post I was creating. But the friction to just get a post out the door was surprisingly high.
